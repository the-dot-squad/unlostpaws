...
/** Full-screen browse map with search and geolocation. Loaded client-side only. */
function ListingsMapContent({ locale, type, petType }) {
...
const ListingsMapClient = dynamic(
  () => Promise.resolve({ default: ListingsMapContent }),
  {
    ssr: false,
