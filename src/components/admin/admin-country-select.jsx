...
/** Searchable country picker for admin (no i18n dependency). */
export function AdminCountrySelect({ value, onChange, label = "Country", id = "country" }) {
            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((option) => (
                <li key={option.code}>
                  ...
                  >
                    <Check className={cn("size-4", value === option.code ? "opacity-100" : "opacity-0")} />
