...
function ListingLifecycleCard({ form, update }) {
  return (
    <Card>
      <CardHeader>
...
function ModerationCard({ form, update }) {
  return (
    <Card>
      <CardHeader>
...
function ImageMatchingCard({ form, update }) {
  return (
    <Card>
      <CardHeader>
...
function ContentSafetyCard({ form, update }) {
  return (
    <Card>
      <CardHeader>
...
function AbuseAutomationCard({ form, update }) {
  return (
    <Card>
      <CardHeader>
  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <ContentSafetyCard form={form} update={update} />
        <AbuseAutomationCard form={form} update={update} />
        <SocialMediaCard
          form={form}
