...
/** Sub-component for location configuration and maps. */
function LocationCard({ form, update, onCoordinatesChange, onReverseGeocode }) {
  return (
    <Card>
      <CardHeader>
...
/** Sub-component for sidebar listing metadata. */
function SidebarCard({ listing, extensionDays }) {
  return (
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_280px]">
        ...
        <div className="space-y-6">
          <DetailsCard form={form} update={update} />
        ...
        {/* Sidebar — metadata */}
        <SidebarCard listing={listing} extensionDays={extensionDays} />
      </div>
    </div>
  );
}
